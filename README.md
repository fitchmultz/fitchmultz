...
- [`pi-cursor-sdk`](https://github.com/fitchmultz/pi-cursor-sdk) — Cursor SDK provider extension for pi, adding Cursor's agent loop to pi
...
- [`pi-copy-message`](https://github.com/fitchmultz/pi-copy-message) — searchable TUI picker plus `/copy-user` shortcut for copying raw session messages.

## More work worth opening

| Project | What it shows | Start here |
|---|---|---|
| [`Promo Studio`](https://github.com/fitchmultz/promo-studio) | Multi-agent commerce demo with receipts, diffs, transcripts, and validation | [What you are seeing](https://github.com/fitchmultz/promo-studio#what-you-are-seeing) |
| [`Ricochet Rush`](https://github.com/fitchmultz/ricochet-rush) | 3D browser game with Cursor SDK backed AI board generation/design and local fallback play | [Demo and QA](https://github.com/fitchmultz/ricochet-rush#demo-and-qa) |
